      ...
      <div className="footer-container">
        <div className="footer-title">
          <div className="footer-logo">
            <h1 className="velocity-logo">VELOCITY</h1>
          </div>
        </div>
        ...
        <div className="footer-social">
          <a href="#" aria-label="Pinterest">
            <svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 17 18">
          ...
          <a href="#" aria-label="Instagram">
            <svg aria-hidden="true" focusable="false" width="24" height="24" viewBox="0 0 18 18">
